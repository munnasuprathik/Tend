  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled ? 'bg-card/80 backdrop-blur-lg shadow-sm border-b border-border' : 'bg-transparent'
      }`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-block">
                <span className="px-4 py-2 bg-secondary/50 text-secondary-foreground rounded-full text-sm font-semibold">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-primary/20 rounded-3xl blur-3xl opacity-20"></div>
              <Card className="relative border shadow-lg">
                <CardContent className="p-8 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground mb-2">🔥 15 Day Streak</p>
                      <p className="font-semibold text-foreground mb-2">Hey Sarah! 👋</p>
                  ...
                  <div className="pt-4 border-t flex items-center justify-between text-sm">
                    <span className="text-muted-foreground">Inspired by Elon Musk</span>
                    <span className="text-primary font-medium">✓ Delivered 9:00 AM EST</span>
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="flex gap-6 items-start">
                <div className="flex-shrink-0 w-16 h-16 bg-primary rounded-2xl flex items-center justify-center text-primary-foreground text-2xl font-bold">
                  {step.step}
                </div>
                ...
                <step.icon className="hidden md:block h-12 w-12 text-primary/20" />
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-12">
            <Button
              onClick={handleSignIn}
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg h-16 px-12"
            >
          ...
          <Card className="bg-primary border-0 shadow-2xl">
            <CardContent className="p-12 space-y-6">
              ...
              <Button
                onClick={handleSignIn}
                size="lg"
                className="bg-card text-primary hover:bg-card/90 text-lg h-14 px-8"
              >
                Get Started Free
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
      ...
      {/* Footer */}
      <footer className="bg-foreground text-foreground/70 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-foreground">Tend</span>
            </div>
